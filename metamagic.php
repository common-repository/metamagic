...
Plugin URI: https://blog.hughestech.com/blog/metamagic/
...
Author URI: https://blog.hughestech.com/blog/

Copyrighted (C)2008 - 2019 Hughes Technologies, Inc. email : designs@hughestech.com
 ...
 $options = get_option( 'metamagic_options' );
      ...
      if( $options['metamagic_enable'] == 1 ) {
           if( is_single() ) {  // Make sure for single post, or all posts will have the same meta tags
               ...
               $keywords = '';
               echo "\n";
               echo '<!-- MetaMagic v1.6 WordPress plugin; https://blog.hughestech.com/blog/metamagic/ -->' . "\n";
...
function metamagic_admin() {
	...
	echo '</form>';
      ...
      echo '<a href="https://wordpress.org/support/view/plugin-reviews/metamagic" target="_blank" title="MetaMagic Reviews">Rate MetaMagic</a><br /><br />';
      ...
      echo 'while editing within the <strong>HTML Editor, Not</strong> the <strong>Visual Editor</strong>!<br /><br />';
